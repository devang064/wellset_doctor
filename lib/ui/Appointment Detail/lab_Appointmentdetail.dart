...
class Lab_appointdetails extends StatefulWidget {
  const Lab_appointdetails({Key? key}) : super(key: key);

  @override
  State<Lab_appointdetails> createState() => _Lab_appointdetailsState();
}

class _Lab_appointdetailsState extends State<Lab_appointdetails> {
  @override
          ...
          child: FlatButton(onPressed: (){
            showDialog(
                ...
                builder: (context){
                  ...
                  //  content: const Text('Congratulations, Your have successfully booked an appointment.',textAlign: TextAlign.center,style: TextStyle(color:Colors.black26 ),),
                    // actions: <Widget>[
                    //   Center(
