...
import 'package:doctor_1/utils/commonbutton.dart';
        ...
        bottomNavigationBar: Padding(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                // ElevatedButton(
                //   style: ElevatedButton.styleFrom(minimumSize: Size(_currentPage == 2 ? MediaQuery.of(context).size.width*0.91:100, 52),
              ...
              CommonButton(
                ...
                borderRadius: 10.r,
                height: 48.h,
                width:_currentPage == 2 ? MediaQuery.of(context).size.width*0.91:100 ,
                label: _currentPage == 2 ? 'continue' : 'next',
